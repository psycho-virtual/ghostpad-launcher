import {
  require_buffer
} from "./chunk-Y5FYI5LT.js";
import {
  __commonJS,
  __esm,
  __export,
  __toCommonJS
} from "./chunk-U5MFFDUF.js";
  ...
  "node_modules/sha.js/sha.js"(exports, module) {
    ...
    Sha.prototype._update = function(M2) {
      ...
      for (var j3 = 0; j3 < 80; ++j3) {
        var s3 = ~~(j3 / 20);
        var t3 = rotl5(a3) + ft(s3, b3, c3, d3) + e3 + W2[j3] + K2[s3] | 0;
        e3 = d3;
        d3 = c3;
        c3 = rotl30(b3);
        b3 = a3;
  ...
  "node_modules/sha.js/sha256.js"(exports, module) {
    ...
    Sha256.prototype._update = function(M2) {
      ...
      for (var j3 = 0; j3 < 64; ++j3) {
        var T1 = h3 + sigma1(e3) + ch(e3, f3, g3) + K2[j3] + W2[j3] | 0;
...
function _(l3, t3, u3) {
  var i3, r4, o3, e3 = {};
  for (o3 in t3)
    "key" == o3 ? i3 = t3[o3] : "ref" == o3 ? r4 = t3[o3] : e3[o3] = t3[o3];
  if (arguments.length > 2 && (e3.children = arguments.length > 3 ? n.call(arguments, 2) : u3), "function" == typeof l3 && null != l3.defaultProps)
    for (o3 in l3.defaultProps)
      void 0 === e3[o3] && (e3[o3] = l3.defaultProps[o3]);
  return m(l3, e3, i3, r4, null);
}
function m(n2, u3, i3, r4, o3) {
  var e3 = { type: n2, props: u3, key: i3, ref: r4, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: null == o3 ? ++t : o3, __i: -1, __u: 0 };
...
function S(n2, l3) {
  ...
  for (var t3; l3 < n2.__k.length; l3++)
    if (null != (t3 = n2.__k[l3]) && null != t3.__e)
      return t3.__e;
...
function $() {
  for (var n2, t3, u3, r4, o3, f3, c3, s3 = 1; i.length; )
    i.length > s3 && i.sort(e), n2 = i.shift(), s3 = i.length, n2.__d && (u3 = void 0, o3 = (r4 = (t3 = n2).__v).__e, f3 = [], c3 = [], t3.__P && ((u3 = w({}, r4)).__v = r4.__v + 1, l.vnode && l.vnode(u3), O(t3.__P, u3, r4, t3.__n, t3.__P.namespaceURI, 32 & r4.__u ? [o3] : null, f3, null == o3 ? S(r4) : o3, !!(32 & r4.__u), c3), u3.__v = r4.__v, u3.__.__k[u3.__i] = u3, z(f3, u3, c3), u3.__e != o3 && C(u3)));
  $.__r = 0;
}
function I(n2, l3, t3, u3, i3, r4, o3, e3, f3, c3, s3) {
  var a3, h3, y3, d3, w3, g3, _3 = u3 && u3.__k || v, m3 = l3.length;
  for (f3 = P(t3, l3, _3, f3, m3), a3 = 0; a3 < m3; a3++)
    null != (y3 = t3.__k[a3]) && (h3 = -1 === y3.__i ? p : _3[y3.__i] || p, y3.__i = a3, g3 = O(n2, y3, h3, i3, r4, o3, e3, f3, c3, s3), d3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && q(h3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), 4 & y3.__u || h3.__k === y3.__k ? f3 = A(y3, f3, n2) : "function" == typeof y3.type && void 0 !== g3 ? f3 = g3 : d3 && (f3 = d3.nextSibling), y3.__u &= -7);
  return t3.__e = w3, f3;
}
function P(n2, l3, t3, u3, i3) {
  var r4, o3, e3, f3, c3, s3 = t3.length, a3 = s3, h3 = 0;
  for (n2.__k = new Array(i3), r4 = 0; r4 < i3; r4++)
    null != (o3 = l3[r4]) && "boolean" != typeof o3 && "function" != typeof o3 ? (f3 = r4 + h3, (o3 = n2.__k[r4] = "string" == typeof o3 || "number" == typeof o3 || "bigint" == typeof o3 || o3.constructor == String ? m(null, o3, null, null, null) : d(o3) ? m(k, { children: o3 }, null, null, null) : void 0 === o3.constructor && o3.__b > 0 ? m(o3.type, o3.props, o3.key, o3.ref ? o3.ref : null, o3.__v) : o3).__ = n2, o3.__b = n2.__b + 1, e3 = null, -1 !== (c3 = o3.__i = L(o3, t3, f3, a3)) && (a3--, (e3 = t3[c3]) && (e3.__u |= 2)), null == e3 || null === e3.__v ? (-1 == c3 && (i3 > s3 ? h3-- : i3 < s3 && h3++), "function" != typeof o3.type && (o3.__u |= 4)) : c3 != f3 && (c3 == f3 - 1 ? h3-- : c3 == f3 + 1 ? h3++ : (c3 > f3 ? h3-- : h3++, o3.__u |= 4))) : n2.__k[r4] = null;
  if (a3)
    for (r4 = 0; r4 < s3; r4++)
      null != (e3 = t3[r4]) && 0 == (2 & e3.__u) && (e3.__e == u3 && (u3 = S(e3)), B(e3, e3));
  return u3;
}
function A(n2, l3, t3) {
  var u3, i3;
  if ("function" == typeof n2.type) {
    for (u3 = n2.__k, i3 = 0; u3 && i3 < u3.length; i3++)
      u3[i3] && (u3[i3].__ = n2, l3 = A(u3[i3], l3, t3));
    return l3;
  }
...
function L(n2, l3, t3, u3) {
  var i3, r4, o3 = n2.key, e3 = n2.type, f3 = l3[t3];
  if (null === f3 && null == n2.key || f3 && o3 == f3.key && e3 === f3.type && 0 == (2 & f3.__u))
    return t3;
  if (u3 > (null != f3 && 0 == (2 & f3.__u) ? 1 : 0))
    for (i3 = t3 - 1, r4 = t3 + 1; i3 >= 0 || r4 < l3.length; ) {
      if (i3 >= 0) {
      ...
      if (r4 < l3.length) {
        if ((f3 = l3[r4]) && 0 == (2 & f3.__u) && o3 == f3.key && e3 === f3.type)
          return r4;
        r4++;
      }
    }
  ...
  n:
    if ("style" == l3)
      if ("string" == typeof t3)
        ...
        if ("string" == typeof u3 && (n2.style.cssText = u3 = ""), u3)
          for (l3 in u3)
            t3 && l3 in t3 || T(n2.style, l3, "");
        if (t3)
          for (l3 in t3)
            u3 && t3[l3] === u3[l3] || T(n2.style, l3, t3[l3]);
      }
    else if ("o" == l3[0] && "n" == l3[1])
      r4 = l3 != (l3 = l3.replace(f, "$1")), l3 = l3.toLowerCase() in n2 || "onFocusOut" == l3 || "onFocusIn" == l3 ? l3.toLowerCase().slice(2) : l3.slice(2), n2.l || (n2.l = {}), n2.l[l3 + r4] = t3, t3 ? u3 ? t3.t = u3.t : (t3.t = c, n2.addEventListener(l3, r4 ? a : s, r4)) : n2.removeEventListener(l3, r4 ? a : s, r4);
    else {
...
function O(n2, t3, u3, i3, r4, o3, e3, f3, c3, s3) {
    ...
    if ("function" == typeof j3)
      try {
        ...
        if (h3.context = M2, h3.props = b3, h3.__P = n2, h3.__e = false, P3 = l.__r, A3 = 0, S2) {
          for (h3.state = h3.__s, h3.__d = false, P3 && P3(t3), a3 = h3.render(h3.props, h3.state, h3.context), H2 = 0; H2 < h3._sb.length; H2++)
        ...
        h3.state = h3.__s, null != h3.getChildContext && (i3 = w(w({}, i3), h3.getChildContext())), S2 && !p3 && null != h3.getSnapshotBeforeUpdate && (_3 = h3.getSnapshotBeforeUpdate(v3, y3)), L2 = a3, null != a3 && a3.type === k && null == a3.key && (L2 = N(a3.props.children)), f3 = I(n2, d(L2) ? L2 : [L2], t3, u3, i3, r4, o3, e3, f3, c3, s3), h3.base = t3.__e, t3.__u &= -161, h3.__h.length && e3.push(h3), m3 && (h3.__E = h3.__ = null);
      } catch (n3) {
        if (t3.__v = null, c3 || null != o3)
          if (n3.then) {
            for (t3.__u |= c3 ? 160 : 128; f3 && 8 == f3.nodeType && f3.nextSibling; )
              f3 = f3.nextSibling;
          ...
          t3.__e = u3.__e, t3.__k = u3.__k;
        l.__e(n3, t3, u3);
      }
    else
      null == o3 && t3.__v == u3.__v ? (t3.__k = u3.__k, t3.__e = u3.__e) : f3 = t3.__e = V(u3.__e, t3, u3, i3, r4, o3, e3, c3, s3);
  return (a3 = l.diffed) && a3(t3), 128 & t3.__u ? void 0 : f3;
}
function z(n2, t3, u3) {
  for (var i3 = 0; i3 < u3.length; i3++)
    q(u3[i3], u3[++i3], u3[++i3]);
...
function V(t3, u3, i3, r4, o3, e3, f3, c3, s3) {
  ...
  if (null === x3)
    b3 === k3 || c3 && t3.data === k3 || (t3.data = k3);
  else {
    if (e3 = e3 && n.call(t3.childNodes), b3 = i3.props || p, !c3 && null != e3)
      for (b3 = {}, a3 = 0; a3 < t3.attributes.length; a3++)
        b3[(w3 = t3.attributes[a3]).name] = w3.value;
    for (a3 in b3)
      if (w3 = b3[a3], "children" == a3)
        ;
    ...
    for (a3 in k3)
      w3 = k3[a3], "children" == a3 ? y3 = w3 : "dangerouslySetInnerHTML" == a3 ? h3 = w3 : "value" == a3 ? _3 = w3 : "checked" == a3 ? m3 = w3 : c3 && "function" != typeof w3 || b3[a3] === w3 || j(t3, a3, w3, b3[a3], o3);
    if (h3)
      c3 || v3 && (h3.__html === v3.__html || h3.__html === t3.innerHTML) || (t3.innerHTML = h3.__html), u3.__k = [];
    else if (v3 && (t3.innerHTML = ""), I("template" === u3.type ? t3.content : t3, d(y3) ? y3 : [y3], u3, i3, r4, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o3, e3, f3, e3 ? e3[0] : i3.__k && S(i3, 0), c3, s3), null != e3)
      for (a3 = e3.length; a3--; )
        g(e3[a3]);
...
function B(n2, t3, u3) {
  ...
  if (i3 = n2.__k)
    for (r4 = 0; r4 < i3.length; r4++)
      i3[r4] && B(i3[r4], t3, u3 || "function" != typeof n2.type);
...
function E(t3, u3, i3) {
  var r4, o3, e3, f3;
  u3 == document && (u3 = document.documentElement), l.__ && l.__(t3, u3), o3 = (r4 = "function" == typeof i3) ? null : i3 && i3.__k || u3.__k, e3 = [], f3 = [], O(u3, t3 = (!r4 && i3 || u3).__k = _(k, null, [t3]), o3 || p, p, u3.namespaceURI, !r4 && i3 ? [i3] : o3 ? null : u3.firstChild ? n.call(u3.childNodes) : null, e3, !r4 && i3 ? i3 : o3 ? o3.__e : u3.firstChild, r4, f3), z(e3, t3, f3);
}
function G(n2, l3) {
  E(n2, l3, G);
}
function J(l3, t3, u3) {
  ...
  for (o3 in l3.type && l3.type.defaultProps && (e3 = l3.type.defaultProps), t3)
    "key" == o3 ? i3 = t3[o3] : "ref" == o3 ? r4 = t3[o3] : f3[o3] = void 0 === t3[o3] && void 0 !== e3 ? e3[o3] : t3[o3];
  return arguments.length > 2 && (f3.children = arguments.length > 3 ? n.call(arguments, 2) : u3), m(l3.type, f3, i3 || l3.key, r4 || l3.ref, null);
}
function K(n2) {
  function l3(n3) {
    var t3, u3;
  ...
  "node_modules/preact/dist/preact.module.js"() {
    ...
    n = v.slice, l = { __e: function(n2, l3, t3, u3) {
      for (var i3, r4, o3; l3 = l3.__; )
        if ((i3 = l3.__c) && !i3.__)
          try {
            if ((r4 = i3.constructor) && null != r4.getDerivedStateFromError && (i3.setState(r4.getDerivedStateFromError(n2)), o3 = i3.__d), null != i3.componentDidCatch && (i3.componentDidCatch(n2, u3 || {}), o3 = i3.__d), o3)
              return i3.__E = i3;
          } catch (l4) {
            n2 = l4;
          }
...
function __disposeResources(env) {
  ...
  function next() {
    while (r4 = env.stack.pop()) {
      try {
        if (!r4.async && s3 === 1)
          return s3 = 0, env.stack.push(r4), Promise.resolve().then(next);
        if (r4.dispose) {
...
*/
//# sourceMappingURL=dist-XWD4WWXF.js.map
